...
from apps.authentication.models import InfoClass, Students, Subject,Users, Attendance,SummaryStudy
...
def list_schedule():
    segment = get_segment(request)
    return render_template('home/schedule/list-schedule.html', rows=scheduler.query.all(), segment=segment)
