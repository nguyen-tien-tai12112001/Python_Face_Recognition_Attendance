...
from apps.home.forms import CreateClass, CreateStudent
from apps.authentication.models import  Schedule, Students, Subject, Teachers,Users,Class, Attendance
...
#Class
@blueprint.route('/list-class/student/<int:msv>', methods=['GET', 'POST'])
def add_student_to_class(msv):
    print(request.data)
    print(request.form)
    print(request.values)
    
    #if 'add_student' in request:
