...
def list_schedule():
    ...
    for event in schedules:
        ...
        b=str(itemClass.id)
        itemSchedule= ItemSchedule(classId=b,className=itemClass.name,subjectName=itemSubject.name,teacheName=itemTeacher.fullname,dateStart=event.startDate,dateEnd=event.endDate)
