...
def list_schedule():
    ...
    for event in schedules:
        ...
        itemSchedule= ItemSchedule(classId=str(itemClass.id),className=itemClass.name,subjectName=itemSubject.name,teacheName=itemTeacher.fullname,dateStart=event.startDate,dateEnd=event.endDate)
