...
from apps.authentication.models import ClassMember, Users,Students
...
def getListStudentByClassId(classId):
    members= ClassMember.query.filter_by(classId=classId)
    students=[]
    # for member in members:
    #     student=Students.query.filter_by(msv=member.msv)
